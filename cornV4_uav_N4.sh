...
# WRF2ARPS directory
wrf2arps=/scratch/admoore/wrf2arps4

# ARPS2WRF directory
arps2wrf=/scratch/admoore/arps2wrf4

# ARPS4WRF directory
arps4wrf=${arps}/arps4wrf/wrf4

# WRFOUT directory
wrfout=/scratch/admoore/wrfout4
...
for hh in ${hours[@]}; do
	...
	then
        ...
        export startmin=${mm}
        export startday=20
        ${arps}/run/input/wrf2arps_input_uav4.sh
        #sbatch ${arps}/wrf2arps4.sh
        ${arps}/bin/wrf2arps < ${arps}/run/input/wrf2arps4.input > wrf2arps4.out
	...
	then 
        ...
        #cd ${arps}
        ${arps}/run/input/adas_wrf_uav4.sh
        #sbatch ${arps}/adas_para4.sh
        #echo "Submitted ADAS....This may take a while..."
        
        cd ${arps}
        bin/adas < run/input/adas_wrf4.input > adas4.out
        cd ${WRFdir}
        ...
        ${arps}/run/input/arps4wrf_wrf_uav4.sh
        cd ${arps}
        #sbatch ${arps}/a4w4.sh
        bin/arps4wrf < run/input/arps4wrf_wrf4.input > arps4wrf4.out
        cd ${WRFdir}        
        ...
        then
            ...
            ################### REAL ####################
                ...
                ${arps}/run/input/wrf2arps_input4.sh
                #sbatch ${arps}/wrf2arps4.sh
	        ...
	        echo ""
                ...
                ${arps}/run/input/arps4wrf_wrf_lbc4.sh
                #sbatch ${arps}/a4w.sh
	...
	# NOTE: Currently the following section is set up to perform hourly DA
        # You will need to make appropriate adjustments to change it back to half hourly!        
         ...
         ################### WRF2ARPS ####################
            ...
            # Now we can pass this through ARPS4WRF
            ${arps}/run/input/arps4wrf_wrf_lbc_uav4.sh
            #sbatch ${arps}/a4w.sh
            echo "Submitted ARPS4WRF"
