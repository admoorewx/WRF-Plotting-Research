...
for hh in ${hours[@]}; do
	...
	then
        ...
        # Since we're only using the UAV data then we don't have to set uaNum or mesoNum
        # These are hard coded in adas_uav.sh as 1 and 0 respectively. 

        ${arps}/run/input/adas_uav.sh
