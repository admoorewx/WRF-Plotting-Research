...
for hh in ${hours[@]}; do
    ...
    ${arps}/run/input/adas_wrf2.sh
    #sbatch ${arps}/adas_serial2.sh
    
    cd ${arps}
    ${arps}/bin/adas < ${arps}/run/input/adas_wrf2.input > ada2.out
    cd ${WRFdir}
    ...
    ${arps}/run/input/arps4wrf_wrf2.sh
    #sbatch ${arps}/a4w.sh
    ...
    then
	    ...
	    echo ""
            ...
            ${arps}/bin/arps4wrf < ${arps}/run/input/arps4wrf_wrf2.input
            #sbatch ${arps}/a4w.sh
