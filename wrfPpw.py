...
#filename = '/scratch/admoore/WRFrun3/10stations/wrfout_d01_2013-05-'+dd+'_'+hh+':'+mm+':00'
...
temp = getvar(ncfile, "td", units="degC")
...
plt.title(title+' '+str(Plevel)+' hPa Dewpoint Temperature (C)')

plt.savefig(outdir+title+'_'+str(Plevel)+'_Td_'+hh+mm)
