...
# File path
filename = '/scratch/admoore/WRFrun3/april_exps/uav3/wrfout_d01_2013-05-'+dd+'_'+hh+':'+mm+':00'
#filename = '/scratch/admoore/wrfout/wrfout_d01_2013-05-20_'+hh+':'+mm+':00_AAA'
#filename = '/scratch/admoore/WRF/5min/arps_'+hh+mm
print(filename)
# Outdirectory
outdir = '/home/admoore/April_exps/uav3/'
...
ht_850 = smooth2d((interplevel(z, p, 850)),smoother)
u_850 = interplevel(ua, p, 850)
v_850 = interplevel(va, p, 850)
wspd_850 = smooth2d((interplevel(wspd, p, 850)),smoother)
