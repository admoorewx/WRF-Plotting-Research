...
# Met_em file directory
metFiles=/scratch/admoore/gfs_metem_051500_hourly
...
for hh in ${hours[@]}; do
    ...
    # Set this to zero to make sure no Upper Air data is used. 
    export uaNum=0
    ...
    then
        ...
        for lbc in ${LBC[@]}; do
            ...
            #ln -sf ${metFiles}/met_em.d01.2013-05-${startday}_${lbc}:00:00.nc ${WRFdir}
            #ln -sf ${metFiles}/met_em.d01.2013-05-${endday}_${endhour}:00:00.nc ${WRFdir}
    ...
    ################################# More LBCs ########################################
        ...
        # Link in new LBC met_em files
        ln -sf ${metFiles}/met_em.d01.2013-05-20_${starthour}:00:00.nc ${WRFdir}
        ln -sf ${metFiles}/met_em.d01.2013-05-20_${endhour}:00:00.nc ${WRFdir}
