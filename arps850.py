...
hh = "06"
mm = "30"
title = 'ARPS Nature Run'

# File path
#filename = '/scratch/admoore/oldNR/wrfout_d01_2013-05-20_'+hh+':'+mm+':00'
...
ht_850 = smooth2d(interplevel(z, p, 850),25)
u_850 = smooth2d(interplevel(ua, p, 850),10)
v_850 = smooth2d(interplevel(va, p, 850),10)
wspd_850 = smooth2d(interplevel(wspd, p, 850),10)
