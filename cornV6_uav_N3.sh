...
for hh in ${hours[@]}; do
	...
	then
        ...
        export startmin=${mm}
        export startday=20
        ${arps}/run/input/wrf2arps_input_uav3.sh
	...
	# Choose the appropriate background error file. 
        ...
        #cd ${arps}
        ${arps}/run/input/adas_wrf_uav3.sh
	sbatch ${arps}/adas_para3.sh
	...
	sleep 30s
        ...
        ${arps}/run/input/arps4wrf_wrf_uav3.sh
        cd ${arps}
        #sbatch ${arps}/a4w.sh
	...
	# NOTE: Currently the following section is set up to perform hourly DA
        # You will need to make appropriate adjustments to change it back to half hourly!        
         ...
         ################### WRF2ARPS ####################
            ...
            # Now we can pass this through ARPS4WRF
            ${arps}/run/input/arps4wrf_wrf_lbc_uav3.sh
            #sbatch ${arps}/a4w.sh
            echo "Submitted ARPS4WRF"
