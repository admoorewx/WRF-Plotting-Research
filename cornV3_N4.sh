...
for hh in ${hours[@]}; do
    ...
    ${arps}/run/input/adas_wrf4.sh
    #sbatch ${arps}/adas_serial4.sh
    
    cd ${arps}
    ${arps}/bin/adas < ${arps}/run/input/adas_wrf4.input > adas.out
    cd ${WRFdir}
    ...
    ${arps}/run/input/arps4wrf_wrf4.sh
    #sbatch ${arps}/a4w.sh

    cd ${arps}
    bin/arps4wrf < run/input/arps4wrf_wrf4.input > arps4wrf.out
    ...
    then
	    ...
	    echo ""
            ...
            ${arps}/bin/arps4wrf < ${arps}/run/input/arps4wrf_wrf4.input
            #sbatch ${arps}/a4w.sh
