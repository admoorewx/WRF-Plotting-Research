...
# * CHANGE jobname to your preferred name for this batch job.
#
#SBATCH --output=/home/admoore/convertout.txt
#SBATCH --error=/home/admoore/converterr.txt
#
...
# * CHANGE jobname to your preferred name for this batch job.
#
#SBATCH --workdir=/home/admoore/scripts
#
...
date
time \
  /home/admoore/scripts/convert_5min.sh \
       \
  && date
