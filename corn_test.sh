...
for hh in ${hours[@]}; do
	...
	then
	    ...
	    cp ${WRFback}/wrfout_d01_2013-05-20_12:00:00 ${wrfout}
            #rm ${wrfout}/wrfout_d01_2013-05-20_12:00:00
	    #cp ${wrfout}/wrfout_d01_2013-05-20_12:00:00_AAA ${wrfout}/wrfout_d01_2013-05-20_12:00:00
        ...
        rm /scratch/admoore/wrf2arps/wrfassim_${hh}${mm}* 2> /dev/null
        ...
        cp /scratch/admoore/wrf2arps/wrfassim_${hh}${mm}.hdf000000 /scratch/admoore/arps2wrf/WRFASSIM_${hh}${mm}.hdf000000 
        cp /scratch/admoore/wrf2arps/wrfassim_${hh}${mm}.hdfgrdbas /scratch/admoore/arps2wrf/WRFASSIM_${hh}${mm}.hdfgrdbas
	...
	#bin/arps3dvar < run/input/adas_wrf.input > 3dvar.out
        ...
        rm ${arps}/arps4wrf/wrf/met_em.d02.2013-05-20_${hh}:${mm}* 2> /dev/null
