...
find /scratch/admoore/WRFrun3 -name 'met_em*' -exec rm {} \;
rm /scratch/admoore/WRFrun3/wrfinput_d01
echo "Removed met_em and wrfinput files."

# Replace these with the saved met_em files from scratch

ln -sf /scratch/admoore/05202013_gfs_metgrid/met_em* /scratch/admoore/WRFrun3

# Check to make sure that the files were correctly linked

if [ -e "/scratch/admoore/WRFrun3/met_em.d01.2013-05-20_12:00:00.nc" ] 
then
...
do
    ...
    then
        ...
        then
            ...
            export max_dom=1
            /scratch/admoore/WRFrun3/namelist_DA.sh
            sbatch /scratch/admoore/WRFrun3/real.sh
            ...
            while [ ! -e '/scratch/admoore/WRFrun3/wrfinput_d01' ] 
            do
                echo "Waiting..."
                counter=$((${counter}+1))
                sleep 2m
            ...
            cp /scratch/admoore/WRFrun3/wrfinput_d01 /scratch/admoore/wrfout/wrfout_d01_2013-05-20_${hh}:00:00
            ...
            cp /scratch/admoore/WRFrun3/wrfout_d01_2013-05-20_${hh}:00:00 /scratch/admoore/wrfout/wrfout_d01_2013-05-20_${hh}:00:00
            # Remove old output files
            rm /scratch/admoore/WRFrun3/wrfout*
        ...
        for lbc in ${LBC[@]}; do 
            ...
            then 
                ...
                #rm /scratch/admoore/WRFrun3/met*

                
                ln -sf /scratch/admoore/05202013_gfs_metgrid/met_em.d01.2013-05-${startday}_${lbc}:00:00.nc /scratch/admoore/WRFrun3/
                ln -sf /scratch/admoore/05202013_gfs_metgrid/met_em.d01.2013-05-${endday}_${endhour}:00:00.nc /scratch/admoore/WRFrun3/
            fi
            ...
            cp /scratch/admoore/WRFrun3/wrfinput_d01 /scratch/admoore/wrfout/wrfout_d01_2013-05-${endday}_${lbc}:00:00
            rm /scratch/admoore/WRFrun3/wrfinput_d01
            echo "Successful run of real.exe."
	...
	if [ ${hh} -lt 18 ] 
        ...
        ################### WRF Forecast ####################
            ...
            rm /scratch/admoore/WRFrun3/wrfinput_d01
            rm /scratch/admoore/WRFrun3/wrfinput_d02
            rm /scratch/admoore/WRFrun3/met_em*
            ln -sf ${arps}/arps4wrf/wrf/met_em* /scratch/admoore/WRFrun3
            ...
            /scratch/admoore/WRFrun3/namelist_DA.sh
            sbatch /scratch/admoore/WRFrun3/realpara.sh
            ...
            sbatch /scratch/admoore/WRFrun3/wrfp.sh
            # Check for WRF output
            counter=0
            while [ ! -e /scratch/admoore/WRFrun3/wrfout_d01_2013-05-20_${endhour}:00:00 ] 
            do 
                echo "waiting..."
                sleep 10m
                counter=$((${counter}+1))
